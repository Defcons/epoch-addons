...
FishingInit.CopyFishSchools = function()
   local schools = {}; -- Claude: fix global leak: was missing local
...
FishingInit.HookFunction = function(func, newfunc)
   local oldValue = _G[func]; -- Claude: replace deprecated getglobal()/setglobal()
...
FishingInit.RegisterFunctionTraps = function()
   local temp = ToggleMinimap; -- Claude: fix global leak: was missing local
...
FishingBuddy.Initialize = function()
   if ( FishingInit ) then
      ...
      local label = _G["FishingBuddyOption_EasyCastKeysLabel"]; -- Claude: replace deprecated getglobal()
