...
local function ItemBonusPoints(item)
   ...
   if ( item and item ~= "" ) then
      ...
      for i=1,FishingBuddyTooltip:NumLines() do
         local mytext = _G["FishingBuddyTooltipTextLeft" .. i] -- Claude: replace deprecated getglobal()
...
local function SetOutfitManagerDisplay()
   ...
   elseif ( OutfitManagerCount == 1 ) then
      ...
      local label = _G["FishingBuddyOption_OutfitMenuLabel"]; -- Claude: replace deprecated getglobal()
